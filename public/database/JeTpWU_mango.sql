...
Source Server         : c（121.196.24.198）
Source Server Version : 80020
Source Host           : 121.196.24.198:3306
Source Database       : JeTpWU_mango

Target Server Type    : MYSQL
Target Server Version : 80020
File Encoding         : 65001

Date: 2021-05-19 15:30:24
*/
...
-- ----------------------------
INSERT INTO `m_page_login` VALUES ('1', '登录页面1', '0', null);
INSERT INTO `m_page_login` VALUES ('2', '登录页面2', '1', null);
INSERT INTO `m_page_login` VALUES ('3', '登录页面', '0', null);
...
-- ----------------------------
INSERT INTO `m_system_admin` VALUES ('1', null, '/static/admin/images/head.jpg', 'admin', 'ed696eb5bba1f7460585cc6975e6cf9bf24903dd', null, '', '82', '0', '1', '1615542339', '1621394247', null);
...
-- ----------------------------
-- Table structure for m_system_command
-- ----------------------------
DROP TABLE IF EXISTS `m_system_command`;
CREATE TABLE `m_system_command` (
...
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COMMENT='在线命令表';

-- ----------------------------
-- Records of m_system_command
-- ----------------------------
INSERT INTO `m_system_command` VALUES ('10', 'crud', '[\"--force=1\",\"--table=r_mall_type\"]', 'php think crud --force=1 --table=r_mall_type', 'Build Successed', '1617244560', '1617244560', '1617244561', 'successed');
INSERT INTO `m_system_command` VALUES ('11', 'crud', '[\"--force=1\",\"--table=r_mall_addons\",\"--fields=id,title,image,market_price,discount_price,sales,weigh,status_switch,remark,create_time\",\"--relation=r_mall_type\",\"--relationmode=belongsto\",\"--relationforeignkey=mall_type_id\",\"--relationprimarykey=id\",\"--relationfields=title\"]', 'php think crud --force=1 --table=r_mall_addons --fields=id,title,image,market_price,discount_price,sales,weigh,status_switch,remark,create_time --relation=r_mall_type --relationmode=belongsto --relationforeignkey=mall_type_id --relationprimarykey=id --relationfields=title', 'Build Successed', '1617244601', '1617244601', '1617244601', 'successed');
INSERT INTO `m_system_command` VALUES ('12', 'crud', '[\"--table=r_friend\"]', 'php think crud --table=r_friend', 'Build Successed', '1617244615', '1617244615', '1617244616', 'successed');
INSERT INTO `m_system_command` VALUES ('13', 'menu', '[\"--controller=Friend\"]', 'php think menu --controller=Friend', 'Build Successed!', '1617244624', '1617244624', '1617244624', 'successed');
INSERT INTO `m_system_command` VALUES ('14', 'crud', '[\"--force=1\",\"--table=r_friend\"]', 'php think crud --force=1 --table=r_friend', 'Build Successed', '1617272467', '1617272467', '1617272467', 'successed');
INSERT INTO `m_system_command` VALUES ('15', 'crud', '[\"--force=1\",\"--table=r_mall_addons\",\"--fields=id,title,image,market_price,discount_price,sales,status_switch,remark,create_time\",\"--relation=r_mall_type\",\"--relationmode=belongsto\",\"--relationforeignkey=mall_type_id\",\"--relationprimarykey=id\",\"--relationfields=title\",\"--relation=r_user\",\"--relationmode=belongsto\",\"--relationforeignkey=user_id\",\"--relationprimarykey=id\",\"--relationfields=username\"]', 'php think crud --force=1 --table=r_mall_addons --fields=id,title,image,market_price,discount_price,sales,status_switch,remark,create_time --relation=r_mall_type --relationmode=belongsto --relationforeignkey=mall_type_id --relationprimarykey=id --relationfields=title --relation=r_user --relationmode=belongsto --relationforeignkey=user_id --relationprimarykey=id --relationfields=username', 'Build Successed', '1617277389', '1617277389', '1617277389', 'successed');
INSERT INTO `m_system_command` VALUES ('16', 'crud', '[\"--force=1\",\"--table=r_mall_addons\",\"--fields=id,title,image,market_price,discount_price,sales,status_switch,remark,create_time\",\"--relation=r_mall_type\",\"--relationmode=belongsto\",\"--relationforeignkey=mall_type_id\",\"--relationprimarykey=id\",\"--relationfields=title\",\"--relation=r_user\",\"--relationmode=belongsto\",\"--relationforeignkey=user_id\",\"--relationprimarykey=id\",\"--relationfields=username\"]', 'php think crud --force=1 --table=r_mall_addons --fields=id,title,image,market_price,discount_price,sales,status_switch,remark,create_time --relation=r_mall_type --relationmode=belongsto --relationforeignkey=mall_type_id --relationprimarykey=id --relationfields=title --relation=r_user --relationmode=belongsto --relationforeignkey=user_id --relationprimarykey=id --relationfields=username', 'Build Successed', '1617277548', '1617277548', '1617277548', 'successed');
INSERT INTO `m_system_command` VALUES ('17', 'crud', '[\"--force=1\",\"--table=r_mall_addons\",\"--fields=id,title,image,market_price,discount_price,describe_content,sales,weigh,status_switch,remark,create_time\",\"--relation=r_mall_type\",\"--relationmode=belongsto\",\"--relationforeignkey=mall_type_id\",\"--relationprimarykey=id\",\"--relationfields=title\",\"--relation=r_user\",\"--relationmode=belongsto\",\"--relationforeignkey=user_id\",\"--relationprimarykey=id\",\"--relationfields=username\"]', 'php think crud --force=1 --table=r_mall_addons --fields=id,title,image,market_price,discount_price,describe_content,sales,weigh,status_switch,remark,create_time --relation=r_mall_type --relationmode=belongsto --relationforeignkey=mall_type_id --relationprimarykey=id --relationfields=title --relation=r_user --relationmode=belongsto --relationforeignkey=user_id --relationprimarykey=id --relationfields=username', 'Build Successed', '1617277879', '1617277879', '1617277879', 'successed');
INSERT INTO `m_system_command` VALUES ('18', 'crud', '[\"--force=1\",\"--table=r_mall_addons\",\"--fields=id,title,image,market_price,discount_price,sales,weigh,version_content,status_switch,remark,create_time\",\"--relation=r_mall_type\",\"--relationmode=belongsto\",\"--relationforeignkey=mall_type_id\",\"--relationprimarykey=id\",\"--relationfields=title\",\"--relation=r_user\",\"--relationmode=belongsto\",\"--relationforeignkey=user_id\",\"--relationprimarykey=id\",\"--relationfields=username\"]', 'php think crud --force=1 --table=r_mall_addons --fields=id,title,image,market_price,discount_price,sales,weigh,version_content,status_switch,remark,create_time --relation=r_mall_type --relationmode=belongsto --relationforeignkey=mall_type_id --relationprimarykey=id --relationfields=title --relation=r_user --relationmode=belongsto --relationforeignkey=user_id --relationprimarykey=id --relationfields=username', 'Build Successed', '1617670901', '1617670901', '1617670901', 'successed');
INSERT INTO `m_system_command` VALUES ('19', 'crud', '[\"--table=r_about\",\"--fields=id,title,image,weigh,status_switch,remark,create_time\"]', 'php think crud --table=r_about --fields=id,title,image,weigh,status_switch,remark,create_time', 'Build Successed', '1617672580', '1617672580', '1617672580', 'successed');
INSERT INTO `m_system_command` VALUES ('20', 'menu', '[\"--controller=About\"]', 'php think menu --controller=About', 'Build Successed!', '1617672586', '1617672586', '1617672586', 'successed');
...
CREATE TABLE `m_system_log_202105` (
  ...
  `create_time` int DEFAULT NULL COMMENT '操作时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=690 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='后台操作日志表 - 202105';
...
INSERT INTO `m_system_log_202105` VALUES ('639', null, '/admin/login/index', 'post', '', '{\"username\":\"admin\",\"password\":\"ed696eb5bba1f7460585cc6975e6cf9bf24903dd\",\"captcha\":\"nwnh\",\"keep_login\":\"0\"}', '27.17.214.11', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1620611347');
INSERT INTO `m_system_log_202105` VALUES ('640', null, '/admin/login/index', 'post', '', '{\"username\":\"admin\",\"password\":\"ed696eb5bba1f7460585cc6975e6cf9bf24903dd\",\"captcha\":\"ctrh\",\"keep_login\":\"1\"}', '219.238.47.3', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.132 Safari/537.36', '1620611377');
INSERT INTO `m_system_log_202105` VALUES ('641', '1', '/admin/login/index', 'post', '', '{\"username\":\"admin\",\"password\":\"ed696eb5bba1f7460585cc6975e6cf9bf24903dd\",\"captcha\":\"ctrh\",\"keep_login\":\"1\"}', '219.238.47.3', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.132 Safari/537.36', '1620611377');
INSERT INTO `m_system_log_202105` VALUES ('642', null, '/admin/login/index', 'post', '', '{\"username\":\"admin\",\"password\":\"ed696eb5bba1f7460585cc6975e6cf9bf24903dd\",\"captcha\":\"iuaz\",\"keep_login\":\"1\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1620627173');
INSERT INTO `m_system_log_202105` VALUES ('643', null, '/admin/login/index', 'post', '', '{\"username\":\"admin\",\"password\":\"ed696eb5bba1f7460585cc6975e6cf9bf24903dd\",\"captcha\":\"capm\",\"keep_login\":\"0\"}', '61.242.134.194', 'Mozilla/5.0 (Linux; Android 10; ONEPLUS A6010 Build/QKQ1.190716.003; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/90.0.4430.91 Mobile Safari/537.36', '1620635474');
INSERT INTO `m_system_log_202105` VALUES ('644', null, '/admin/login/index', 'post', '', '{\"username\":\"admin\",\"password\":\"ed696eb5bba1f7460585cc6975e6cf9bf24903dd\",\"captcha\":\"tuhz\",\"keep_login\":\"1\"}', '61.242.134.194', 'Mozilla/5.0 (Linux; Android 10; ONEPLUS A6010 Build/QKQ1.190716.003; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/90.0.4430.91 Mobile Safari/537.36', '1620635484');
INSERT INTO `m_system_log_202105` VALUES ('645', '1', '/admin/login/index', 'post', '', '{\"username\":\"admin\",\"password\":\"ed696eb5bba1f7460585cc6975e6cf9bf24903dd\",\"captcha\":\"tuhz\",\"keep_login\":\"1\"}', '61.242.134.194', 'Mozilla/5.0 (Linux; Android 10; ONEPLUS A6010 Build/QKQ1.190716.003; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/90.0.4430.91 Mobile Safari/537.36', '1620635574');
INSERT INTO `m_system_log_202105` VALUES ('646', null, '/admin/login/index.html', 'post', '', '{\"username\":\"admin\",\"password\":\"ed696eb5bba1f7460585cc6975e6cf9bf24903dd\",\"captcha\":\"h5pk\",\"keep_login\":\"1\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1620701491');
INSERT INTO `m_system_log_202105` VALUES ('647', null, '/admin/login/index.html', 'post', '', '{\"username\":\"admin\",\"password\":\"ed696eb5bba1f7460585cc6975e6cf9bf24903dd\",\"captcha\":\"ucxq\",\"keep_login\":\"0\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1620702360');
INSERT INTO `m_system_log_202105` VALUES ('648', null, '/admin/login/index', 'post', '', '{\"username\":\"admin\",\"password\":\"ed696eb5bba1f7460585cc6975e6cf9bf24903dd\",\"captcha\":\"mmea\",\"keep_login\":\"0\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1620703965');
INSERT INTO `m_system_log_202105` VALUES ('649', '1', '/admin/login/index', 'post', '', '{\"username\":\"admin\",\"password\":\"ed696eb5bba1f7460585cc6975e6cf9bf24903dd\",\"captcha\":\"mmea\",\"keep_login\":\"0\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1620703967');
INSERT INTO `m_system_log_202105` VALUES ('650', null, '/admin/login/index', 'post', '', '{\"username\":\"admin\",\"password\":\"ed696eb5bba1f7460585cc6975e6cf9bf24903dd\",\"captcha\":\"xiv8\",\"keep_login\":\"1\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1620713573');
INSERT INTO `m_system_log_202105` VALUES ('651', null, '/admin/login/index', 'post', '', '{\"username\":\"admin\",\"password\":\"ed696eb5bba1f7460585cc6975e6cf9bf24903dd\",\"captcha\":\"2etv\",\"keep_login\":\"1\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1620801594');
INSERT INTO `m_system_log_202105` VALUES ('652', null, '/admin/login/index', 'post', '', '{\"username\":\"admin\",\"password\":\"ed696eb5bba1f7460585cc6975e6cf9bf24903dd\",\"captcha\":\"nlnt\",\"keep_login\":\"1\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1620801604');
INSERT INTO `m_system_log_202105` VALUES ('653', null, '/admin/login/index', 'post', '', '{\"username\":\"admin\",\"password\":\"ed696eb5bba1f7460585cc6975e6cf9bf24903dd\",\"captcha\":\"q5lj\",\"keep_login\":\"1\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.93 Safari/537.36 Edg/90.0.818.56', '1620805877');
INSERT INTO `m_system_log_202105` VALUES ('654', null, '/admin/login/index', 'post', '', '{\"username\":\"admin\",\"password\":\"ed696eb5bba1f7460585cc6975e6cf9bf24903dd\",\"captcha\":\"qin4\",\"keep_login\":\"1\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1620891932');
INSERT INTO `m_system_log_202105` VALUES ('655', null, '/admin/login/index', 'post', '', '{\"username\":\"admin\",\"password\":\"ed696eb5bba1f7460585cc6975e6cf9bf24903dd\",\"captcha\":\"qin3\",\"keep_login\":\"1\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1620891935');
INSERT INTO `m_system_log_202105` VALUES ('656', null, '/admin/login/index', 'post', '', '{\"username\":\"admin\",\"password\":\"ed696eb5bba1f7460585cc6975e6cf9bf24903dd\",\"captcha\":\"6whj\",\"keep_login\":\"1\"}', '27.17.135.217', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1620957461');
INSERT INTO `m_system_log_202105` VALUES ('657', null, '/admin/login/index', 'post', '', '{\"username\":\"admin\",\"password\":\"ed696eb5bba1f7460585cc6975e6cf9bf24903dd\",\"captcha\":\"3xwb\",\"keep_login\":\"0\"}', '220.202.232.194', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:88.0) Gecko/20100101 Firefox/88.0', '1620957586');
INSERT INTO `m_system_log_202105` VALUES ('658', '1', '/admin/ajax/upload', 'post', '', '[]', '220.202.232.194', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:88.0) Gecko/20100101 Firefox/88.0', '1620957652');
INSERT INTO `m_system_log_202105` VALUES ('659', '1', '/admin/ajax/upload', 'post', '', '[]', '220.202.232.194', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:88.0) Gecko/20100101 Firefox/88.0', '1620957660');
INSERT INTO `m_system_log_202105` VALUES ('660', null, '/admin/login/index', 'post', '', '{\"username\":\"admin\",\"password\":\"ed696eb5bba1f7460585cc6975e6cf9bf24903dd\",\"captcha\":\"s77p\",\"keep_login\":\"1\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1620957714');
INSERT INTO `m_system_log_202105` VALUES ('661', '1', '/admin/system.admin/modify', 'post', '', '{\"id\":\"1\",\"field\":\"status\",\"value\":\"0\"}', '220.202.232.194', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:88.0) Gecko/20100101 Firefox/88.0', '1620957779');
INSERT INTO `m_system_log_202105` VALUES ('662', '1', '/admin/mall.goods/delete?id=9', 'post', '', '{\"id\":\"9\"}', '27.17.135.217', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1620960866');
INSERT INTO `m_system_log_202105` VALUES ('663', null, '/admin/login/index', 'post', '', '{\"username\":\"admin\",\"password\":\"ed696eb5bba1f7460585cc6975e6cf9bf24903dd\",\"captcha\":\"uyjt\",\"keep_login\":\"1\"}', '101.80.88.112', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.9 Safari/537.36', '1621055468');
INSERT INTO `m_system_log_202105` VALUES ('664', '1', '/admin/system.node/refreshNode?force=0', 'post', '', '{\"force\":\"0\"}', '101.80.88.112', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.9 Safari/537.36', '1621055839');
INSERT INTO `m_system_log_202105` VALUES ('665', null, '/admin/login/index', 'post', '', '{\"username\":\"admin\",\"password\":\"ed696eb5bba1f7460585cc6975e6cf9bf24903dd\",\"captcha\":\"tfz7\",\"keep_login\":\"1\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1621218933');
INSERT INTO `m_system_log_202105` VALUES ('666', '1', '/admin/login/index', 'post', '', '{\"username\":\"admin\",\"password\":\"ed696eb5bba1f7460585cc6975e6cf9bf24903dd\",\"captcha\":\"tfz7\",\"keep_login\":\"1\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1621218934');
INSERT INTO `m_system_log_202105` VALUES ('667', '1', '/admin/addons/login_page/back/edit?id=3', 'post', '', '{\"id\":\"3\",\"title\":\"登录页面33\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1621222512');
INSERT INTO `m_system_log_202105` VALUES ('668', '1', '/admin/addons/login_page/back/edit?id=3', 'post', '', '{\"id\":\"3\",\"title\":\"登录页面33\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1621222751');
INSERT INTO `m_system_log_202105` VALUES ('669', null, '/admin/login/index', 'post', '', '{\"username\":\"admin\",\"password\":\"ed696eb5bba1f7460585cc6975e6cf9bf24903dd\",\"captcha\":\"db8x\",\"keep_login\":\"0\"}', '221.194.6.62', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:88.0) Gecko/20100101 Firefox/88.0', '1621230738');
INSERT INTO `m_system_log_202105` VALUES ('670', null, '/admin/login/index', 'post', '', '{\"username\":\"admin\",\"password\":\"ed696eb5bba1f7460585cc6975e6cf9bf24903dd\",\"captcha\":\"a3db\",\"keep_login\":\"1\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1621307720');
INSERT INTO `m_system_log_202105` VALUES ('671', '1', '/admin/login/index', 'post', '', '{\"username\":\"admin\",\"password\":\"ed696eb5bba1f7460585cc6975e6cf9bf24903dd\",\"captcha\":\"a3db\",\"keep_login\":\"1\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1621307723');
INSERT INTO `m_system_log_202105` VALUES ('672', null, '/admin/login/index', 'post', '', '{\"username\":\"admin\",\"password\":\"ed696eb5bba1f7460585cc6975e6cf9bf24903dd\",\"captcha\":\"k7nh\",\"keep_login\":\"1\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1621386707');
INSERT INTO `m_system_log_202105` VALUES ('673', null, '/admin/login/index', 'post', '', '{\"username\":\"admin\",\"password\":\"ed696eb5bba1f7460585cc6975e6cf9bf24903dd\",\"captcha\":\"ubtr\",\"keep_login\":\"1\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1621389733');
INSERT INTO `m_system_log_202105` VALUES ('674', '1', '/admin/addons/login_page/back/edit?id=3', 'post', '', '{\"id\":\"3\",\"title\":\"登录页面\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1621393453');
INSERT INTO `m_system_log_202105` VALUES ('675', null, '/admin/login/index', 'post', '', '{\"username\":\"admin\",\"password\":\"933761dbd108bff31a6bbb8b4b059ffc1830de49\",\"captcha\":\"gjiq\",\"keep_login\":\"0\"}', '27.17.135.217', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1621394235');
INSERT INTO `m_system_log_202105` VALUES ('676', null, '/admin/login/index', 'post', '', '{\"username\":\"admin\",\"password\":\"933761dbd108bff31a6bbb8b4b059ffc1830de49\",\"captcha\":\"ykkg\",\"keep_login\":\"0\"}', '27.17.135.217', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1621394239');
INSERT INTO `m_system_log_202105` VALUES ('677', null, '/admin/login/index', 'post', '', '{\"username\":\"admin\",\"password\":\"ed696eb5bba1f7460585cc6975e6cf9bf24903dd\",\"captcha\":\"kadn\",\"keep_login\":\"0\"}', '27.17.135.217', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1621394246');
INSERT INTO `m_system_log_202105` VALUES ('678', '1', '/admin/system.menu/add', 'post', '', '{\"pid\":\"0\",\"title\":\"大师傅\",\"href\":\"\",\"icon\":\"fa fa-list\",\"target\":\"_self\",\"sort\":\"0\",\"remark\":\"\"}', '27.17.135.217', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1621394294');
INSERT INTO `m_system_log_202105` VALUES ('679', '1', '/admin/system.menu/delete?id=227', 'post', '', '{\"id\":\"227\"}', '27.17.135.217', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1621394299');
INSERT INTO `m_system_log_202105` VALUES ('680', '1', '/admin/system.admin/delete?id=1', 'post', '', '{\"id\":\"1\"}', '27.17.135.217', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1621394309');
INSERT INTO `m_system_log_202105` VALUES ('681', '1', '/admin/system.admin/edit?id=1', 'post', '', '{\"id\":\"1\",\"head_img\":\"\\/static\\/admin\\/images\\/head.jpg\",\"file\":\"\",\"username\":\"admin\",\"phone\":\"admin\",\"remark\":\"admin\"}', '27.17.135.217', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1621394316');
INSERT INTO `m_system_log_202105` VALUES ('682', '1', '/admin/system.auth/delete?id=1', 'post', '', '{\"id\":\"1\"}', '27.17.135.217', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1621394330');
INSERT INTO `m_system_log_202105` VALUES ('683', '1', '/admin/system.node/modify', 'post', '', '{\"id\":\"1\",\"field\":\"is_auth\",\"value\":\"0\"}', '27.17.135.217', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1621394335');
INSERT INTO `m_system_log_202105` VALUES ('684', '1', '/admin/system.node/modify', 'post', '', '{\"id\":\"1\",\"field\":\"is_auth\",\"value\":\"0\"}', '27.17.135.217', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1621394337');
INSERT INTO `m_system_log_202105` VALUES ('685', '1', '/admin/system.config/save', 'post', '', '{\"site_name\":\"芒果后台系统\",\"site_ico\":\"http:\\/\\/mango.cn\\/upload\\/20210314\\/266d9bc4d6b893fa5590bbdd772b3ddd.ico\",\"file\":\"\",\"site_version\":\"2.0.0\",\"site_beian\":\"粤ICP备16006642号-2\",\"site_copyright\":\"©版权所有 2014-2018 叁贰柒工作室66\"}', '27.17.135.217', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1621394346');
INSERT INTO `m_system_log_202105` VALUES ('686', '1', '/admin/system.quick/delete?id=11', 'post', '', '{\"id\":\"11\"}', '27.17.135.217', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1621394354');
INSERT INTO `m_system_log_202105` VALUES ('687', '1', '/admin/system.menu/add?id=228', 'post', '', '{\"id\":\"228\",\"pid\":\"228\",\"title\":\"一键开发\",\"href\":\"\",\"icon\":\"fa fa-laptop\",\"target\":\"_self\",\"sort\":\"0\",\"remark\":\"\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1621394506');
INSERT INTO `m_system_log_202105` VALUES ('688', '1', '/admin/system.menu/edit?id=365', 'post', '', '{\"id\":\"365\",\"pid\":\"228\",\"title\":\"一键开发\",\"href\":\"system.plugin\\/index\",\"icon\":\"fa fa-laptop\",\"target\":\"_self\",\"sort\":\"0\",\"remark\":\"\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1621394589');
INSERT INTO `m_system_log_202105` VALUES ('689', '1', '/admin/system.menu/edit?id=365', 'post', '', '{\"id\":\"365\",\"pid\":\"228\",\"title\":\"一键开发\",\"href\":\"system.command\\/index\",\"icon\":\"fa fa-laptop\",\"target\":\"_self\",\"sort\":\"0\",\"remark\":\"\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36', '1621394979');
...
CREATE TABLE `m_system_menu` (
  ...
  KEY `title` (`title`),
  KEY `href` (`href`)
) ENGINE=InnoDB AUTO_INCREMENT=366 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='系统菜单表';
...
INSERT INTO `m_system_menu` VALUES ('349', '1', '登录页面', 'fa fa-list', '/addons/login_page/back/index', '', '_self', '0', '1', null, 'login_page', '1620702263', '1620702263', null);
INSERT INTO `m_system_menu` VALUES ('365', '228', '一键开发', 'fa fa-laptop', 'system.command/index', '', '_self', '0', '1', '', '', '1621394507', '1621394980', null);
